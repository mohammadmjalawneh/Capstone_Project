						...
						<form method="POST" action="" enctype="multipart/form-data">
							<div class="form-group row">
								...
								<div class="col-12 col-sm-8 col-lg-6">
									<input type="text" required="" placeholder="product name" name="name" class="form-control" value="<?php if (isset($_GET['Eid'])) {
							...
							<div class="form-group row">
								...
								<div class="col-12 col-sm-8 col-lg-6">
									<textarea required="" class="form-control" value="" cols="10" rows="5" name="description"><?php if (isset($_GET['Eid'])) {
								...
								<div class="col-12 col-sm-8 col-lg-6">
									<select name="subcat" id="subcat" class="form-control" required="">
										...
										if (isset($_GET['Eid'])) {
											...
											echo "<option value='{$bra['subcat_id']}
'>" . $bra1['subcat_name'] . "</option>";
										}
							...
							<div class="form-group row">
								...
								if (isset($_GET['Eid'])) {
									...
									<div class='card card-figure'>
										<!-- .card-figure -->
										<figure class='figure'>
											<img class='img-fluid' src='pro_img/{$imag['pro_img']}
' alt='Card image cap'>
											<!-- .figure-caption -->
											<figcaption class='figure-caption'>
											<h6 class='figure-title'> Image {$i}
</h6>
							...
							<table id="example" class="table table-striped table-bordered second" style="width:100%">
								...
								<tbody>
									...
									while ($pro = $res->fetch_assoc()) {
										...
										echo "<td><a href='product_man.php?Eid={$pro['pro_id']}
' class='btn btn-rounded btn-success'>Edit</a></td>";
										if ($pro['pro_sta']) {
											echo "<td><a href='product_man.php?Did={$pro['pro_id']}
' class='btn btn-rounded btn-danger'>Delete</a></td>";
										} else {
											echo "<td><a href='product_man.php?aid={$pro['pro_id']}
' class='btn btn-rounded btn-primary'>Active</a></td>";
										}

 ...
 */
(function(d, f, g, b) {
    if (!d) { console.error("jQuery nÃ£o encontrado, seu plugin jQuery nÃ£o irÃ¡ funcionar."); return false }(function() {
        var k = 0,
            l = ["ms", "moz", "webkit", "o"];
        ...
        if (!f.requestAnimationFrame) {
            f.requestAnimationFrame = function(q, n) {
                ...
                var p = f.setTimeout(function() { q(m + o) }, o);
                k = m + o;
                return p
            }
        }
        if (!f.cancelAnimationFrame) { f.cancelAnimationFrame = function(m) { clearTimeout(m) } }
    })();
    var e = "parallax",
    ...
    d.extend(h.prototype, {
        init: function() {
            var j = this;
            this.$triggerOrigin.on(j.settings.on + "." + j._name, function() { j.parallaxTranslate() });
            j.parallaxTranslate()
        },
        ...
        somePublicMethod: function(k, j) { privateMethod.call(this) },
        inScreen: function(l) {
            var o;
            ...
            var k = a.scrollTop(),
                ...
                j = o.offset().top,
                m = j + o.height();
            if (l === true) { return k <= j && n >= m }
            return !(k > m || n < j)
        }
    });
    d.fn[e] = function(k) { var j = arguments; if (k === b || typeof k === "object") { return this.each(function() { if (!d.data(this, "plugin_" + e)) { d.data(this, "plugin_" + e, new h(this, k)) } }) } else { if (typeof k === "string" && k !== "init") { return this.each(function() { var l = d.data(this, "plugin_" + e); if (l instanceof h && typeof l[k] === "function") { l[k].apply(l, Array.prototype.slice.call(j, 1)) } }) } } }

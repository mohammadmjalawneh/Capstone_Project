					...
					<div class="card-body">
						<form method="POST" action="" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input  type="text" name="fname" data-parsley-trigger="change" required="" placeholder="Enter First Name" 
								value="<?php
								if(isset($_GET['Eid'])){
									echo $Adm['ad_fname'];
								} 
							...
							<div class="form-group">
								...
								<input type="name" name="mname" data-parsley-trigger="change" required="" placeholder="Enter Middle name" 
								value="<?php
								if(isset($_GET['Eid'])){
									echo $Adm['ad_mname'];
								} 
							...
							<div class="form-group">
								...
								<input type="text" name="lname" data-parsley-trigger="change" required="" placeholder="Enter Last name" 
								value="<?php
								if(isset($_GET['Eid'])){
									echo $Adm['ad_lname'];
								} 

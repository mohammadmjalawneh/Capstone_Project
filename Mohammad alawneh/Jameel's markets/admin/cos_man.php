					...
					<div class="card-body">
						<form action="#" id="basicform" method="POST" data-parsley-validate="">
							...
							<div class="form-group">
								...
								<input id="inputEmail" type="email" name="email" data-parsley-trigger="change" required="" placeholder="Enter email" autocomplete="off" class="form-control" value="<?php if (isset($_GET['eid'])) {
																																																		echo $I3['cos_email'];
																																																	}
																																																	?>">
							</div>
							<div class="form-group">
								...
								<input id="inputPassword" type="password" placeholder="Password" required="" class="form-control" name="password" value="<?php if (isset($_GET['eid'])) {
																																								echo $I3['cos_pass'];
																																							}
																																							?>">
							</div>
							<div class="form-group">
								...
								<input id="inputRepeatPassword" data-parsley-equalto="#inputPassword" type="password" required="" placeholder="Password" class="form-control" value="<?php if (isset($_GET['eid'])) {
																																															echo $I3['cos_pass'];
																																														}
																																														?>">
							</div>
							<div class="form-group">
								...
								<input id="xphone-mask" type="text" name="mobile" required="" placeholder="Mobile phone" class="form-control" value="<?php if (isset($_GET['eid'])) {
																																							echo $I3['cos_mobile'];
																																						}
																																						?>">
							</div>
							...
							<table id="example" class="table table-striped table-bordered second" style="width:100%">
								...
								<tbody>
									...
									while ($I = $res->fetch_assoc()) {
										...
										echo "<td>{$I['cos_mobile']}
</td>";
										if ($I['cos_status']) {
											echo "<td class='text-success'>Active</td>";
											echo "<td><a href='cos_man.php?eid={$I['cos_id']}
' class='btn btn-outline-warning'>Edit</a></td>";
											echo "<td><a href='cos_man.php?did={$I['cos_id']}
' class='btn btn-outline-danger'>Deactivate</a></td>";
										} else {
											echo "<td class='text-danger'>Disactive</td>";
											echo "<td></td>";
											echo "<td><a href='cos_man.php?aid={$I['cos_id']}
' class='btn btn-outline-success'>Activate</a></td>";
										}

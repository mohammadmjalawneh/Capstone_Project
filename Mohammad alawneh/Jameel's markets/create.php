				...
				<div class="row">
					<div class="col-lg-8 col-md-8">
						...
						<form action="" method="post" enctype="multipart\form-data">
							...
							<div class="mt-10">
								<input type="text" name="mname" placeholder="Mid. Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Last Name'" required class="single-input">
							</div>
							<div class="mt-10">
							...
							<div class="mt-10">
								<input type="password" name="pass" placeholder="Password" id="inputPassword" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Password'" required class="single-input-primary">
							</div>
							<div class="mt-10">
								<input type="password" id="inputRepeatPassword" name="re-type" placeholder="Re-type Password" data-parsley-equalto="#inputPassword" onfocus="this.placeholder = 'retype your password'" onblur="this.placeholder = 'retype your password'" required class="single-input-accent">
							</div>
							<div class="mt-10">
								<input type="tel" name="mobile" placeholder="Your mobile" onfocus="this.placeholder = 'Your mobile'" onblur="this.placeholder = 'Your mobile'" required class="single-input-secondary">
							</div>
							<div class="mt-5">
